...
def create_dataset_for_modeling(): #num_ballots_to_generate
    ...
    # election_level_features_df,'num_candidates', 'noise', 

    master_df =ballot_level_features_df[['pyrankvote_winner', 'condorcet_winner', 'spoiled', 'filename']]
    ...
    master_df.to_csv('final_mastertoday.csv', index=False)

    


if __name__ == "__main__":
    create_dataset_for_modeling()
